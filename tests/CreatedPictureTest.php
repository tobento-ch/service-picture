...
use Tobento\Service\Picture\CreatedPicture;
...
class CreatedPictureTest extends TestCase
{
    public function testThatImplementsInterfaces()
    {
        $picture = new CreatedPicture(
            img: new Img(
                src: new Src(),
            ),
            sources: new Sources(),
        ...
        $this->assertInstanceof(CreatedPictureInterface::class, $picture);
    ...
    public function testImgMethod()
    {
        ...
        $picture = new CreatedPicture(img: $img, sources: new Sources());
    ...
    {
        $picture = new CreatedPicture(img: new Img(src: new Src()), sources: new Sources());
    ...
    {
        $sources = new Sources();
        $picture = new CreatedPicture(img: new Img(src: new Src()), sources: $sources);
    ...
    public function testAttributesMethod()
    {
        $this->assertSame(
            [],
            (new CreatedPicture(img: new Img(src: new Src()), sources: new Sources()))->attributes()
        );
        
        $this->assertSame(
            ['key' => 'value'],
            (new CreatedPicture(img: new Img(src: new Src()), sources: new Sources(), attributes: ['key' => 'value']))->attributes()
        );
    }
    
    public function testWithAttributesMethod()
    {
        $picture = new CreatedPicture(img: new Img(src: new Src()), sources: new Sources(), attributes: ['key' => 'value']);
    ...
    public function testOptionsMethod()
    {
        $this->assertSame(
            [],
            (new CreatedPicture(img: new Img(src: new Src()), sources: new Sources()))->options()
        );
        
        $this->assertSame(
            ['key' => 'value'],
            (new CreatedPicture(img: new Img(src: new Src()), sources: new Sources(), options: ['key' => 'value']))->options()
        );
    }
    
    public function testWithOptionsMethod()
    {
        $picture = new CreatedPicture(img: new Img(src: new Src()), sources: new Sources(), options: ['key' => 'value']);
    ...
    {
        $picture = new CreatedPicture(img: new Img(src: new Src(url: 'url')), sources: new Sources());
